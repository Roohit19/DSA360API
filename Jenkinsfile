pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = "roohit19/dsa360-${DATE_TIME}"
    ...
    stages {
        stage('Get Code') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/Roohit19/DSA360API.git'
            }
        }
            ...
            steps {
                script {
                    ...
                    existingImages.split('\n').each { img ->
                        if (img.contains("roohit19/dsa360-")) {
            ...
            steps {
                script {
                    ...
                    withCredentials([string(credentialsId: 'dockerpassword', variable: 'dockerpassword')]) {
                        bat "docker login -u roohit19 -p ${dockerpassword}"
